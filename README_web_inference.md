...
systemd-run \
  ...
  --property=WorkingDirectory=/home/shaoyu/glove_tracking \
  ...
  /bin/bash -lc '
    exec env PYTHONUNBUFFERED=1 \
      ...
      /home/shaoyu/miniconda3/bin/conda run --no-capture-output -n glove-hot3d \
      python hand_restoration_web.py --share \
      >> /home/shaoyu/glove_tracking/hand-inference-web.log 2>&1
  '
```
...
```bash
tail -f /home/shaoyu/glove_tracking/hand-inference-web.log
```
